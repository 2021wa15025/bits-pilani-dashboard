    ...
    <Card className="bg-university-primary text-white p-4 sm:p-8 border-none shadow-lg relative overflow-hidden">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between relative z-10 gap-4">
        <div className="flex-1 w-full">
          <div className="flex items-center gap-3 sm:gap-4 mb-3">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
              <GreetingIcon className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
            </div>
        ...
        <div className="w-full sm:w-auto sm:text-right">
          <Button
            className="bg-white text-university-primary hover:bg-white/90 dark:bg-white dark:text-university-primary dark:hover:bg-white/90 font-medium rounded-lg w-full sm:w-auto"
            size={typeof window !== 'undefined' && window.innerWidth < 640 ? "sm" : "lg"}
            onClick={onViewSchedule}
          >
            <span className="sm:hidden text-university-primary">Calendar</span>
            <span className="hidden sm:inline text-university-primary">View Schedule</span>
            <ArrowRight className="w-4 h-4 ml-2 text-university-primary" />
          </Button>
        </div>
      </div>
