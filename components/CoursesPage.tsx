...
function CoursesPage({ courses, onCourseClick }: CoursesPageProps) {
  ...
  return (
    <div className="space-y-6 bg-[rgba(0,0,0,0)]">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          <div className="relative flex-1 sm:flex-initial">
            ...
            <Input
              ...
              className="pl-10 w-full sm:w-64 no-underline text-gray-600"
            />
          </div>
          <select
      ...
      <div className="flex justify-center mb-8">
        <Card className="bg-[#191f5e] dark:bg-[#191f5e] border-[#191f5e] dark:border-[#191f5e] shadow-lg">
          <CardContent className="p-8">
            <div className="space-y-6">
              {/* Header */}
              <div>
                <h3 className="text-base font-medium text-white dark:text-white mb-1">
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <div className="w-full h-5 bg-white/20 dark:bg-white/20 border border-white/30 rounded-full overflow-hidden">
                    <div 
                ...
                <div className="flex justify-center mt-4">
                  <div className="bg-[#191f5e] dark:bg-[#191f5e] border border-[#191f5e] px-6 py-2 rounded-full">
      ...
      {/* Filter Tabs - Full Width Connected Style */}
      <div className="flex w-full p-1 bg-gray-100 dark:bg-slate-700 rounded-full">
        <button
          onClick={() => setFilterStatus("all")}
          className={`flex-1 py-2 md:py-3 rounded-full text-xs md:text-sm font-medium transition-all ${
            filterStatus === "all"
              ? "bg-[#191f5e] text-white shadow-md"
