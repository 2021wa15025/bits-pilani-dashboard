  ...
  return (
    ...
    >
      ...
      <div className="px-5 flex-1 overflow-hidden">
        <p className="text-university-secondary leading-relaxed line-clamp-6 h-full overflow-hidden text-ellipsis break-words text-xs">
...
function NotesPage({ courses, notes: propNotes, onNoteClick, onNotesChange }: NotesPageProps) {
        ...
        <div className="flex gap-4 items-center mb-6">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button 
                variant="outline" 
                className="flex items-center gap-2 min-w-[140px] justify-between text-xs text-university-primary dark:text-white dark:border-white dark:hover:border-white"
              >
                {selectedCourse === "all" ? "All Courses" : 
                 availableCourses.find(c => c === selectedCourse)?.substring(0, 15) + "..." || "All Courses"}
                <ChevronDown className="w-4 h-4 text-muted-foreground dark:text-gray-300" />
              </Button>
            </DropdownMenuTrigger>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button 
                variant="outline" 
                className="flex items-center gap-2 min-w-[120px] justify-between text-xs text-university-primary dark:text-white dark:border-white dark:hover:border-white"
              >
